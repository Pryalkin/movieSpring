package com.bsuir.moviesearchsystem.exception;
...
import static com.bsuir.moviesearchsystem.constant.ExceptionConstant.*;
...
public class ExceptionHandling {
    ...
    public ResponseEntity<HttpResponse> levelException(LevelException exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }

    @ExceptionHandler(GenreException.class)
    public ResponseEntity<HttpResponse> genreException(GenreException exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }
